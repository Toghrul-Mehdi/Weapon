...
namespace Weapon
{
    internal class Weapon
    {
        ...
        public void ChangeCap(int newcap)
        {
            if (Capacity == newcap)
            {
                Console.WriteLine("Tutum deyismedi!");
            }
            else if(Capacity !=newcap)
            {
                Console.WriteLine("Tutum deyisdi:");
            }
            Capacity=newcap;
        }
        ...
        public void ChangeBullet(int newbullet)
        {
            if(Bullet == newbullet)
            {
                Console.WriteLine("Gulle deyismedi");
            }
            else if(Bullet != newbullet)
            {
                Console.WriteLine("Gulle deyisdi");
            }
            Bullet=newbullet;
        }
